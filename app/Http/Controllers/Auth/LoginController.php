    ...
    */
    ...
    public function authenticated(Request $request, $user)
    {
        ...
        $data = array(
                ...
                "name"=> $user->username,
                "email"=> $user->email,
                "body"=> "Dear customer, We noticed a successful login to your account. Is this you? if not please change your account password immediately. Remember, do not disclose your login credentials to anybody. We will never ask for it.", 
    ...
    $message->to($user->email, $user->username)->subject('Login Notification');
});
