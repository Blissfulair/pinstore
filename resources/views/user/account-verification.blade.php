...
{{ csrf_field() }}
                            ...
                            <div class="kyc-app wide-ssm m-autso">
                                <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                    <div class="nk-block-head-content text-center">
                                        <h2 class="nk-block-title fw-normal">Update your profile</h2>
                                        <div class="nk-block-des">
                                            <p>To comply with regulation each applicant will have to go through indentity verification. </p>
                                        </div>
                                    </div>
                                </div><!-- nk-block -->
                                <div class="nk-block">
                                        ...
                                        <div class="nk-kycfm">
                                          ...
                                          <div class="nk-kycfm-head">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="fname" value="{{Auth::user()->fname?Auth::user()->fname:old('fname')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input name="lname" type="text" class="form-control form-control-lg" value="{{Auth::user()->lname?Auth::user()->lname:old('lname')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" readonly value="{{Auth::user()->email}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" readonly value="{{Auth::user()->phone}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text"  class="form-control form-control-lg date-picker-alt" value="{{Auth::user()->dob?Auth::user()->dob:old('dob')}}" name="dob">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <select type="text" class="form-control form-control-lg" name="gender" >
                                                                <option>Male</option>
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="address" value="{{Auth::user()->address?Auth::user()->address:old('address')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <label class="form-label">City of Residence <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="city" value="{{Auth::user()->city?Auth::user()->city:old('city')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="state" value="{{Auth::user()->state?Auth::user()->state:old('state')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg date-picker-alt" name="country" value="{{Auth::user()->country?Auth::user()->country:old('country')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="zip" vvalue="{{Auth::user()->zip?Auth::user()->zip:old('zip')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                            ...
                                            <div class="nk-kycfm-head">
                                                ...
                                                <div class="nk-kycfm-title">
                                                    <h5 class="title">Qualification Level</h5>
                                                    <p class="sub-title">Your qualification is required</p>
                                                </div>
                                            </div><!-- nk-kycfm-head -->
                                            <div class="nk-kycfm-content">
                                                <div class="nk-kycfm-note">
                                                    <em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Tooltip on right"></em>
                                                    <p>Highest institution attained </p>
                                                </div>
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="institute" value="{{Auth::user()->institute?Auth::user()->institute:old('institute')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="qualification" value="{{Auth::user()->qualification?Auth::user()->qualification:old('qualification')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" name="grade" value="{{Auth::user()->grade?Auth::user()->grade:old('grade')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg date-picker-alt" name="year_admitted" value="{{Auth::user()->year_admitted?Auth::user()->year_admitted:old('year_admitted')}}">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" class="form-control form-control-lg" value="{{Auth::user()->year_of_graduation?Auth::user()->year_of_graduation:old('year_of_graduation')}}" name="year_of_graduation">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                            ...
                                            <div class="nk-kycfm-content">
                                                ...
                                                <ul class="nk-kycfm-control-list g-3">
                                                    <li class="nk-kycfm-control-item">
                                                        <input class="nk-kycfm-control" type="radio" name="type" id="passport" data-title="Passport" value="International Passport" checked>
                                                        <label class="nk-kycfm-label" for="passport">
                                                            <span class="nk-kycfm-label-icon">
                                                                <div class="label-icon">
                                                                    <svg xmlns="#" viewBox="0 0 71.9904 75.9285">
                                                    ...
                                                    <li class="nk-kycfm-control-item">
                                                        <input class="nk-kycfm-control" type="radio" name="type" id="national-id" data-title="National ID" value="National ID Card" >
                                                        <label class="nk-kycfm-label" for="national-id">
                                                            <span class="nk-kycfm-label-icon">
                                                                <div class="label-icon">
                                                                    <svg xmlns="#" viewBox="0 0 76 63.0105">
                                                    ...
                                                    <li class="nk-kycfm-control-item">
                                                        <input class="nk-kycfm-control" type="radio" name="type" value="Drivers License" id="driver-licence" data-title="Driving License">
                                                        <label class="nk-kycfm-label" for="driver-licence">
                                                            <span class="nk-kycfm-label-icon">
                                                                <div class="label-icon">
                                                                    <svg xmlns="#" viewBox="0 0 76 76.1">
                                                ...
                                                <div class="nk-kycfm-upload">
                                                    <h6 class="title nk-kycfm-upload-title">Upload Here Your Means Of Identification</h6>
                                                    <div class="row align-items-center">
                                                        <div class="col-sm-8">
                                                            <div class="nk-kycfm-upload-box">
                                                                <div class="upload-zone">
                                                                     <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" name="photo" value="{{Auth::user()->phone?Auth::user()->phone:old('phone')}}" id="customFile">
                                            ...
                                            <div class="nk-kycfm-content">
                                                <div class="nk-kycfm-note">
                                                    <em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Tooltip on right"></em>
                                                    <p>Either PDF or DOCX.</p>
                                                </div>
                                                <div class="nk-kycfm-upload">
                                                    <h6 class="title nk-kycfm-upload-title">Upload Here Your Curriculum Vitae</h6>
                                                    <div class="row align-items-center">
                                                        <div class="col-sm-8">
                                                            <div class="nk-kycfm-upload-box">
                                                                <div class="upload-zone">
                                                                     <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" name="cv" value="{{Auth::user()->cv?Auth::user()->cv:old('cv')}}" id="customFile">
                                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                                                    </div>
                                                                </div>
                                                            </div>
 ...
 <input class="form-control"  placeholder="Enter The ID Number Written On The Document"  type="text" id="token-address" value="{{Auth::user()->number?Auth::user()->number:old('number')}}" name="number" >
<span class="text-primary">Note: Ensure you enter a complete ID Number.</span>
 </div><!-- .input-item -->

<br>
 <div class="input-item input-with-label"><label for="token-address" class="input-item-label">ID Expiry Date:</label><input class="form-control  date-picker-dob" type="text" id="date-of-birth" placeholder="Enter The Expiry Date Of Document" name="date" value="{{Auth::user()->date?Auth::user()->date:old('date')}}" ></div>
 <br>
