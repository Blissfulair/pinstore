                                    ...
                                    <div class="alert alert-warning">
                                        <div class="alert-cta flex-wrap flex-md-nowrap">
                                            ...
                                            <ul class="alert-actions gx-3 mt-3 mb-1 my-md-0">
                                                <li class="order-md-last"><a href="{{ route('verification')}}" class="btn btn-sm btn-warning">Verify</a></li>
                                                <li><a href="{{ route('verification')}}" class="link link-primary">Learn More</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                @endif
