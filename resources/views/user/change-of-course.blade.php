                                ...
                                <div class="nk-block">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <img style="width:70%;margin-bottom:30px;height:300px;border-radius:30px" src="{{asset('assets/images/jamb.jpg')}}" >
                                    ...
                                    <div class="card card-bordered">
                                        ...
                                        <a  href="{{route('fund-wallet')}}" class="btn btn-primary">Proceed to paystack</a>
