...
<div class="x_mark" style="text-align:center"><a href="{{url('/')}}" target="_blank" style="text-align:center; color:#4183C4; text-decoration:none"><div style="display: inline-block; max-width: 99.9%;"><img src="{{asset('assets/images/favicon.png')}}" alt="{{$basic->sitename}}" width="152" height="28" class="x_center x_logo-wordmark" style="outline:none; text-decoration:none; width:auto; max-width:100%; border:none; margin:0 auto; float:none; padding:25px 0 17px; text-align:center"></div> </a></div>
</td>
