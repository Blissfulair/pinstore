                        ...
                        <div class="page-nav w-100 w-lg-auto">
                            <ul class="nav">
                             @foreach($network as $k=>$data)
                                <li class="nav-item"><a class="nav-link" href="{{route('admin.airtimesalesind', $data->code)}}">{{$data->name}}</a></li>
                             @endforeach
                                    <li class="nav-item"><a class="nav-link" href="{{route('admin.airtimesales')}}">All</a></li>

                            </ul>
                        </div>
                        <div class="search flex-grow-1 pl-lg-4 w-100 w-sm-auto">
                            <form action="{{route('admin.airtimesearch')}}" method="POST" autocomplete="off">
                            {{ csrf_field() }}
