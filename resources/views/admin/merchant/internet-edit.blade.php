        ...
        <div class="card content-area">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">{{$decoder->name}} {{$network->name}} Data</h4>
                ...
                <div class="card-text">
                    <p>Please fill the form below to update your {{$network->name}} internet data subscription plan</p>
                </div>
                <div class="gaps-2x"></div>
                <div class="row">
                    <div class="col-12">
                        <form role="form" method="POST" enctype="multipart/form-data" action="{{route('admin.internetplanpost',$network->id)}}">
                        {{ csrf_field() }}
                            <div class="gaps-1x"></div>
                            <div class="row">
                            <div class="col-md-6">
                                    <div class="input-item input-with-label">
                                        <label class="input-item-label">Network Name</label>
