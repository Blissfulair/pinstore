                                ...
                                <div class="stage-action">
                                    ...
                                    <div class="toggle-class dropdown-content dropdown-content-top-left">
                                        <ul class="dropdown-list">
                                            <li><a href="{{route('admin.powerview', $data->id)}}"  >Overview</a></li>
                                            @if($data->status == 1)
                                            <li><a href="{{route('admin.powerdisable', $data->id)}}">Disable</a></li>

                                            @else <li><a href="{{route('admin.powervenable', $data->id)}}">Enable</a></li>
                                            @endif
