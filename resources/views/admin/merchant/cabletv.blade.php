        ...
        <div class="card content-area">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Available Available Networks</h4>
                </div>
                                ...
                                <div class="stage-action">
                                    ...
                                    <div class="toggle-class dropdown-content dropdown-content-top-left">
                                        <ul class="dropdown-list">
                                            <li><a href="{{route('admin.cabletvview', $data->id)}}"  >Overview</a></li>
                                            @if($data->status == 1)
                                            <li><a href="{{route('admin.cabletvdisable', $data->id)}}">Disable</a></li>

                                            @else <li><a href="{{route('admin.cabletvenable', $data->id)}}">Enable</a></li>
                                            @endif
                            ...
                            <div class="stage-info">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="stage-info-txt">
                                            <h6>TRX Charges</h6>
                                            <div class="h2 stage-info-number">{{$data->fee}}<small>{{$basic->currency}}</small></div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="stage-info-txt">
