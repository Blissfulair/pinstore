                        ...
                        <div class="page-nav w-100 w-lg-auto">
                            <ul class="nav">
                             @foreach($network as $k=>$data)
                                <li class="nav-item"><a class="nav-link" href="{{route('cabletvind', $data->code)}}">{{$data->name}}</a></li>
                             @endforeach
                                    <li class="nav-item"><a class="nav-link" href="{{route('admin.cabletvplantrx')}}">All</a></li>
                ...
                <table class="data-table admin-tnx ">
                    <thead>
                        <tr class="data-item data-head">
                            ...
                            <th class="data-col dt-token">Decoder Number</th>
                            <th class="data-col dt-token">Plan Amount</th>
                    ...
                    @foreach($trx as $k=>$data)
                        <tr class="data-item" id="tnx-item-2">
                            ...
                            <td class="data-col dt-token">
                                <span class="lead token-amount">{{$data->plan}}</span>
                                 <span class="sub sub-symbol">Bouquet</span>

                            </td>
                            <td class="data-col dt-token">

                                <span class="lead amount-pay">{{$data->phone}}</span>
                                <span class="sub sub-symbol">{{App\Decoder::whereCode($data->network)->first()->name}} <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="Decoder Name"></em></span>
                                                            </td>
                            <td class="data-col dt-token">
