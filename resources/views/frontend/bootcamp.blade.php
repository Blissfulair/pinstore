...
<section class="container">
    ...
    <div class="panel panel-default">
        ...
        <h4 class="panel-title">
            ...
            <i class="fa fa-arrow-right"></i> <span>Givitec code bootcamp</span>
            </a>
        </h4>
        </div>
        <div class="panel-collapse" role="tabpanel" >
        <div class="panel-content">
           <p style="font-size:16px;">Apply here for The Givitec code bootcamp holding @ 192 MM Way, Benin City - 08079436049, 09016659733
                          ...
                          <div class="col-md-4">
                              <section class="panel advert-items">
                                  ...
                                  <div class="panel-body text-center">
                                      ...
                                      <div  class="amount" style="text-align:center;margin-left:10px; font-size: 24px;color: white;">
                                       &#8358;4000
                                      </div>
                                  </div>
                                 <div style="width:100%">
