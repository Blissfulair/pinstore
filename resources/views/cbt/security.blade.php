                        ...
                        <div class="container-xl wide-lg">
                            <div class="nk-content-body">
                                ...
                                <ul class="nk-nav nav nav-tabs">
                                    <li class="nav-item"><a class="nav-link" href="{{route('cbt.profile')}}">Personal</a></li>
                                    <li class="nav-item"><a class="nav-link  active" href="#">Bank Details</a></li>
                                ...
                                <div class="nk-block">
                                    ...
                                    <div class="nk-data data-list">
                                        ...
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                            <div class="data-col"><span class="data-label">Bank Name</span><span class="data-value">{{isset(Auth::guard('cbt')->user()->bank) ? Auth::guard('cbt')->user()->bank : 'N/A'}}</span></div>
                                        ...
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                            <div class="data-col"><span class="data-label">Account Number</span><span class="data-value text-soft">{{isset(Auth::guard('cbt')->user()->accountno) ? Auth::guard('cbt')->user()->accountno : 'N/A'}}</span></div>
                                            <div class="data-col data-col-end">
                                                <span class="data-more"><em class="icon ni ni-forward-ios"></em></span>
                                            </div>
                                        </div>
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                            <div class="data-col"><span class="data-label">Account Name</span><span class="data-value">{{isset(Auth::guard('cbt')->user()->accountname) ? Auth::guard('cbt')->user()->accountname : 'N/A'}}</span></div>
                                            <div class="data-col data-col-end">
                                                <span class="data-more"><em class="icon ni ni-forward-ios"></em></span>
                                            </div>
                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-lg">
                        ...
                        <div class="tab-content">
                           ...
                           <form method="post" action="{{route('cbt.post.banky') }}">
@csrf
                                <div class="row gy-4">
                                    <div class="col-md-12">
                                    <script>
...
<?php $method = DB::table('localbanks')->get(); ?>
