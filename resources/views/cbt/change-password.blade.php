   ...
   <div class="nk-content nk-content-fluid">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" class="form-validate" action="{{route('cbt.change-password') }}">
@csrf
...
@csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input class="form-control" type="number" id="new-pass"  name="password">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="phone-no">Confirm New Pin</label>
                            <div class="form-control-wrap">
                                <input class="form-control" type="number" id="confirm-pass" name="password_confirmation"  >
                            </div>
                        </div>
