                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">My Withdrawals</h3>
                                                @php
                                                 $count = \App\WithdrawLog::whereCbt_id(Auth::guard('cbt')->user()->id)->count();
                                                 @endphp
                                                <div class="nk-block-des text-soft"><p>You have a total of {{$count}} {{$count==1?'withdrawal':'witdrawals'}}</p></div>
                                            </div>
                                            <div class="nk-block-head-content">
                                            ...
                                            <div class="card-inner-group">
                                                <div class="card-inner">
                                                    <div class="card-title-group">
                                                        <div class="card-title"><h5 class="title">All Withdrawals</h5></div>
                                                            ...
                                                            <div class="nk-tb-col">
                                                                <div class="nk-tnx-type">
                                                                   ...
                                                                   <div class="nk-tnx-type-icon bg-success-dim text-success">
                                                                    ...
                                                                    <div class="nk-tnx-type-text"><span class="tb-lead" style="text-transform:capitalize">{{$data->transaction_id}}</span></div>
                                                                </div>
                                                            </div>

                                                            <div class="nk-tb-col text-right">
                                                                <span class="tb-amount">{{$data->amount}}</span>
                                                            </div>
                                                                ...
                                                                <div class="dot dot-success d-md-none"></div>
                                                                 @if($data->status == 1)
                                                                   <span class="badge badge-sm badge-dim badge-outline-success d-none d-md-inline-flex">Completed</span>
                                                                    ...
                                                                    @elseif($data->status == -1)
                                                                    <span class="badge badge-sm badge-dim badge-outline-danger d-none d-md-inline-flex">Resend Details</span>
                                                                    @endif
