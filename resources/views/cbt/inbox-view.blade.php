...
<div class="nk-ibx-reply-item nk-reply-item"><div class="nk-reply-header nk-ibx-reply-header"><div class="nk-reply-desc"><div class="nk-reply-avatar user-avatar bg-blue"><img src="{{asset('assets/images/logo/logo.png')}}" alt=""></div><div class="nk-reply-info"><div class="nk-reply-author lead-text">Admin <span class="date d-sm-none">{{ Carbon\Carbon::parse($inbox->created_at)->diffForHumans() }}</span></div><div class="dropdown nk-reply-msg-info"><a href="#" class="dropdown-toggle sub-text dropdown-indicator" data-toggle="dropdown">to Me</a><div class="dropdown-menu dropdown-menu-md"><ul class="nk-reply-msg-meta"><li><span class="label">from:</span> <span class="info"><a href="#">{{$basic->email}}</a></span></li><li><span class="label">to:</span> <span class="info"><a href="#">{{Auth::gaurd('cbt')->user()->username}} </a></span></li> </ul></div></div> </div></div><ul class="nk-reply-tools g-1"><li class="date-msg"><span class="date">{{ Carbon\Carbon::parse($inbox->created_at)->diffForHumans() }}</span></li>  </ul></div><div class="nk-reply-body nk-ibx-reply-body"><div class="nk-reply-entry entry"><p>Hello {{Auth::gaurd('cbt')->user()->username}} ,</p><p>{{$inbox->details}}</p><p>Regards. <br> {{$basic->sitename}}</p></div></div></div>
