                                ...
                                <div class="nk-block">
                                    <div class="row gy-gs">
                                                            ...
                                                            <div class="nk-wg7">
                                                                ...
                                                                <div class="nk-wg7-stats-group">
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Withdrawn</div>
                                                                        <div class="number">{{number_format($total_funded,2)}} </div>
                                                                    </div>
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Pending Withdraw</div>
                                                                        <div class="number">{{number_format($pending_withdraw,2)}} </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="col-lg-5 col-xl-6">
                                            <div class="nk-block">
                                                <div class="nk-block-head-xs">
                                                    <div class="nk-block-head-content"><h5 class="nk-block-title title">Work</h5></div>
                                                </div>
                                                <div class="nk-block">
                                                    <div class="card card-bordered text-light is-dark h-100">
                                                        <div class="card-inner">
                                                            <div class="nk-wg7">
                                                                ...
                                                                <div class="nk-wg7-stats-group">
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Chane of Institution/Course</div>
                                                                        <div class="number">{{number_format($pending, 0)}} </div>
                                                                    </div>
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Upload of Results</div>
