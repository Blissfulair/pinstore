...
<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-wallet text-primary "></em></span><span class="nk-menu-text">Deposit</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{ route('depositfiat') }}" class="nk-menu-link"><span class="nk-menu-text">Deposit Fiat</span></a></li><li class="nk-menu-item"><a href="{{ route('depositcrypto') }}"  class="nk-menu-link"><span class="nk-menu-text">Deposit Crypto</span></a></li><li class="nk-menu-item"><a href="{{route('user.depositLog')}}" class="nk-menu-link"><span class="nk-menu-text">Deposit Log</span></a></li> </ul></li>


<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-money text-primary"></em></span><span class="nk-menu-text">Withdraw</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{route('withdraw.money')}}" class="nk-menu-link"><span class="nk-menu-text">New Request</span></a></li><li class="nk-menu-item"><a href="{{route('user.withdrawLog')}}" class="nk-menu-link"><span class="nk-menu-text">Withdrawal Log</span></a></li>
<li class="nk-menu-item"><a href="{{route('convertbonus')}}" class="nk-menu-link"><span class="nk-menu-text">Convert Bonus</span></a></li> </ul></li>

<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-tranx text-primary"></em></span><span class="nk-menu-text">Fund Transfer</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{route('transfer')}}" class="nk-menu-link"><span class="nk-menu-text">Transfer Fund</span></a></li>
<li class="nk-menu-item"><a href="{{route('transferlog')}}" class="nk-menu-link"><span class="nk-menu-text">Transfer Log</span></a></li>
 </ul></li>


  <li class="nk-menu-item"><a href="{{route('mobilerecharge')}}" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-mobile text-primary"></em></span><span class="nk-menu-text">Airtime Topup</span></a></li>

 <li class="nk-menu-item"><a href="{{route('internetdata')}}" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-wifi text-primary"></em></span><span class="nk-menu-text">Internet Bundle</span></a></li>

 <li class="nk-menu-item"><a href="{{route('cabletv')}}" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-monitor text-primary"></em></span><span class="nk-menu-text">TV Subscription</span></a></li>

<li class="nk-menu-item"><a href="{{route('electricity')}}" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-bulb text-primary"></em></span><span class="nk-menu-text">Electricity Bills</span></a></li>

<li class="nk-menu-item"><a href="{{route('convertairtime')}}" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-cards-fill text-primary"></em></span><span class="nk-menu-text">Convert Airtime</span></a></li>


<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-cart text-primary"></em></span><span class="nk-menu-text">Payment Log</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{route('tvlog')}}" class="nk-menu-link"><span class="nk-menu-text">TV Subscriptions</span></a></li>
<li class="nk-menu-item"><a href="{{route('powerlog')}}" class="nk-menu-link"><span class="nk-menu-text">Electricity Bills</span></a></li>
<li class="nk-menu-item"><a href="{{route('internetlog')}}" class="nk-menu-link"><span class="nk-menu-text">Internet Subscriptions</span></a></li>
<li class="nk-menu-item"><a href="{{route('rechargelog')}}" class="nk-menu-link"><span class="nk-menu-text">Mobile Phone Recharges</span></a></li>

<li class="nk-menu-item"><a href="{{route('conversionlog')}}" class="nk-menu-link"><span class="nk-menu-text">Airtime Conversion</span></a></li>
 </ul></li>




<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-apple-pay-fill text-primary"></em></span><span class="nk-menu-text">Trade Giftcards</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{route('sellgift')}}" class="nk-menu-link"><span class="nk-menu-text">Exchange Gift-Card</span></a></li><li class="nk-menu-item"><a href="{{route('excardlog')}}" class="nk-menu-link"><span class="nk-menu-text">Exchange Log</span></a></li></ul></li>
...
<li class="nk-menu-item"><a href="{{route('user.faq')}}"" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-help text-primary"></em></span><span class="nk-menu-text">FAQ</span></a></li></ul></div>
...
<div class="nk-sidebar-footer"><ul class="nk-menu nk-menu-footer"><li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-help-alt text-primary"></em></span><span class="nk-menu-text">Support</span></a></li><li class="nk-menu-item ml-auto"><div class="dropup"><a href="#" class="nk-menu-link dropdown-indicator has-indicator" data-toggle="dropdown" data-offset="0,10"><span class="nk-menu-icon"><em class="icon ni ni-globe"></em></span><span class="nk-menu-text">English</span></a><div class="dropdown-menu dropdown-menu-sm dropdown-menu-right"><ul class="language-list"><li><a href="#" class="language-item"><img src="../images/flags/english.png" alt="" class="language-flag"><span class="language-name">English</span></a></li><li><a href="#" class="language-item"><img src="../images/flags/spanish.png" alt="" class="language-flag"><span class="language-name">Español</span></a></li><li><a href="#" class="language-item"><img src="../images/flags/french.png" alt="" class="language-flag"><span class="language-name">Français</span></a></li><li><a href="#" class="language-item"><img src="../images/flags/turkey.png" alt="" class="language-flag"><span class="language-name">Türkçe</span></a></li></ul></div></div></li></ul></div></div></div></div></div><div class="nk-wrap "><div class="nk-header nk-header-fluid nk-header-fixed bg-primary"><div class="container-fluid"><div class="nk-header-wrap"><div class="nk-menu-trigger d-xl-none ml-n1"><a href="#" class="nk-nav-toggle nk-quick-nav-icon" data-target="sidebarMenu"><em class="icon ni ni-menu"></em></a></div><div class="nk-header-brand d-xl-none"><a href="{{route('home')}}" class="logo-link"><img class="logo-light logo-img" src="{{asset('assets/images/favicon.png')}}" srcset="{{asset('assets/images/favicon.png')}}" alt="logo"><img class="logo-dark logo-img" src="{{asset('assets/images/favicon.png')}}" srcset="{{asset('assets/images/favicon.png')}}" alt="logo-dark"> </a></div><div class="nk-header-news d-none d-xl-block"><div class="nk-news-list"><a class="nk-news-item" href="#"><div class="nk-news-icon"><em class="icon ni ni-card-view"></em></div><div class="nk-news-text"><p >Do you know you can create you personal blockchain wallet? <span> You wallet is a step away!!</span></p><em class="icon ni ni-external"></em></div></a></div></div><div class="nk-header-tools"><ul class="nk-quick-nav"><li class="dropdown user-dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><div class="user-toggle"><div class="user-avatar sm"> @if( file_exists(Auth::User()->image))
 ...
 <div class="user-avatar"><span>{{substr(Auth::user()->fname, 0, 1)}}{{substr(Auth::user()->lname, 0, 1)}}</span></div><div class="user-info"><span class="lead-text">{{Auth::user()->username}}</span><span class="sub-text">{{Auth::user()->email}}</span></div></div></div><div class="dropdown-inner user-account-info"><h6 class="overline-title-alt">Fiat Account</h6><div class="user-balance">{{number_format(Auth::user()->balance, $basic->decimal)}}   <small class="currency currency-btc">{{$basic->currency}}</small></div><div class="user-balance-sub">Bonus <span>{{number_format(Auth::user()->bonus, $basic->decimal)}} <span class="currency currency-btc">{{$basic->currency}}</span></span></div> </div><div class="dropdown-inner"><ul class="link-list"> <li><a href="{{route('profile')}}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li><li><a href="{{route('activities')}}"><em class="icon ni ni-activity-alt"></em><span>Login Activity</span></a></li></ul></div><div class="dropdown-inner"><ul class="link-list"><li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li></ul></div></div></li><li class="dropdown notification-dropdown mr-n1"><a href="#" class="dropdown-toggle nk-quick-nav-icon" data-toggle="dropdown">
  <?php $coins = DB::table('messages')->whereStatus(0)->whereUser_id(Auth::user()->id)->get(); ?>
